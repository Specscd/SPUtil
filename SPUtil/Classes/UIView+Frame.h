...
@property (nonatomic, assign) CGFloat tp_bottom;
@property (nonatomic, assign) CGFloat tp_right;
@property (nonatomic, assign) CGFloat tp_centerX;
@property (nonatomic, assign) CGFloat tp_centerY;
