...
// general appearance
const CGFloat CSToastMaxWidth = 0.8;  // 80% of parent view width
const CGFloat CSToastMaxHeight = 0.8; // 80% of parent view height
const CGFloat CSToastHorizontalPadding = 15.0;
const CGFloat CSToastVerticalPadding = 15.0;
const CGFloat CSToastCornerRadius = 8.0;
const CGFloat CSToastOpacity = 0.6;
const CGFloat CSToastFontSize = 15.0;
const CGFloat CSToastMaxTitleLines = 0;
const CGFloat CSToastMaxMessageLines = 0;
const NSTimeInterval CSToastFadeDuration = 0.2;

// shadow appearance
const CGFloat CSToastShadowOpacity = 0.4;
const CGFloat CSToastShadowRadius = 4.0;
const CGSize CSToastShadowOffset = {0.0, 1.0};
const BOOL CSToastDisplayShadow = YES;

// display duration
const NSTimeInterval CSToastDefaultDuration = 3.0;

// image view size
const CGFloat CSToastImageViewWidth = 80.0;
const CGFloat CSToastImageViewHeight = 80.0;

// activity
const CGFloat CSToastActivityWidth = 100.0;
const CGFloat CSToastActivityHeight = 100.0;
const NSString *CSToastActivityDefaultPosition = @"center";

// interaction
const BOOL CSToastHidesOnTap = YES; // excludes activity views

// associative reference keys
NSString *const CSToastTimerKey = @"CSToastTimerKey";
NSString *const CSToastActivityViewKey = @"CSToastActivityViewKey";
NSString *const CSToastTapCallbackKey = @"CSToastTapCallbackKey";

// positions
NSString *const CSToastPositionTop = @"top";
NSString *const CSToastPositionCenter = @"center";
NSString *const CSToastPositionUpKeyboard = @"UpKeyboard";
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast
{
    if ([point isKindOfClass:[NSString class]]) {
        ...
        } else if ([point caseInsensitiveCompare:CSToastPositionUpKeyboard] == NSOrderedSame) {
            return CGPointMake(0, 0); /*unknonw type for veeu app*/
